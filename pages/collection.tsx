...
const Collection: NextPage = () => {
  ...
  useEffect(() => {
    if (publicKey) {
      setLoading(true)
      getAllNftsByOwner(metaplex).then((data) => {
        setNfts(data)
        setLoading(false)
      })
    } else {
  ...
  return (
    <div>
      ...
      <div className="w-full h-full mt-40 bg-[#191621] flex flex-col items-center justify-center">
        ...
        <form className="w-full lg:w-[50%] px-10  py-20">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Insert NFT address..."
              required
            />
            <button
              type="submit"
